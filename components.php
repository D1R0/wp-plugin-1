    ...
    ?>
        ...
        <div class="col">
            <form method="post" class="form-ETD">
                <input type="hidden" name="project_series" value="<?php echo esc_attr($project_details->series); ?>" maxlength="191">
                ...
                <input type="text" name="project_status" value="<?php echo esc_attr($project_details->status); ?>" maxlength="191">
        ...
        <div class="col-6-responsive">
            ...
            <form method="post" enctype="multipart/form-data" class="form-upload-ETD">
                <label for="ch4Files" class="drop-container" id="dropcontainer">
                    ...
                    Sau
                    <input type="file" name="csv_file" id="ch4Files" accept=".csv" required>
                </label>
